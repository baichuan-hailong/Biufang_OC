...
-(instancetype)initWithFrame:(CGRect)frame
    ...
    if (self = [super initWithFrame:frame]) {
        ...
        _segmentToolView=[[LiuXSegmentView alloc] initWithFrame:CGRectMake(0, 0, MainScreen_W, 40) titles:titleArray clickBlick:^void(NSInteger index) {
...
-(UIScrollView *)bgScrollView{
    if (!_bgScrollView) {
        ...
        _bgScrollView.backgroundColor=[UIColor colorWithHex:BACK_COLOR];
