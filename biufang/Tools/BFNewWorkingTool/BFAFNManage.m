...
+(instancetype)shareManager{
    ...
    static BFAFNManage * manager = nil;
...
-(instancetype)initWithBaseURL:(NSURL *)url{
    ...
    if (self = [super initWithBaseURL:url]) {
       ...
       /**设置接受的类型*/
        ...
        //NSLog(@"biufang/%@(iPhone %@;%@)",VERSION,[DeviceInfoManage deviceModelName],[DeviceInfoManage getDeviceInfo]);
        ...
        [self.requestSerializer setValue:@"application/json" forHTTPHeaderField:@"Content-Type"];
        //User-Agent
        [self.requestSerializer setValue:[NSString stringWithFormat:@"biufang/%@ (iPhone %@;%@)",VERSION,[DeviceInfoManage deviceModelName],[DeviceInfoManage getDeviceInfo]] forHTTPHeaderField:@"User-Agent"];
...
+(void)requestWithType:(HttpRequestType)type withUrlString:(NSString *)urlString withParaments:(id)paraments withSuccessBlock:(requestSuccess)successBlock withFailureBlock:(requestFailure)failureBlock progress:(downloadProgress)progress{
    ...
    switch (type) {
        ...
        case HttpRequestTypeGet:{
            [[BFAFNManage shareManager] GET:urlString parameters:paraments progress:^(NSProgress * _Nonnull downloadProgress) {
        ...
        case HttpRequestTypePost:{
            [[BFAFNManage shareManager] POST:urlString parameters:paraments progress:^(NSProgress * _Nonnull uploadProgress) {
...
+(void)cancelAllRequest
{
    ...
    [[BFAFNManage shareManager].operationQueue cancelAllOperations];
...
+(void)cancelHttpRequestWithRequestType:(NSString *)requestType requestUrlString:(NSString *)string
{
    ...
    NSString * urlToPeCanced = [[[[BFAFNManage shareManager].requestSerializer requestWithMethod:requestType URLString:string parameters:nil error:&error] URL] path];
    
    
    for (NSOperation * operation in [BFAFNManage shareManager].operationQueue.operations) {
